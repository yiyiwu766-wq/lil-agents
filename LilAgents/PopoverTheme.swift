...
struct PopoverTheme {
    ...
    static let teenageEngineering = PopoverTheme(
        ...
        font: NSFont(name: "SFMono-Regular", size: 22) ?? .monospacedSystemFont(ofSize: 22, weight: .regular),
        fontBold: NSFont(name: "SFMono-Medium", size: 22) ?? .monospacedSystemFont(ofSize: 22, weight: .medium),
        ...
        bubbleFont: .monospacedSystemFont(ofSize: 21, weight: .medium),
    ...
    static let playful = PopoverTheme(
        ...
        fontBold: .systemFont(ofSize: 22, weight: .semibold),
        ...
        bubbleFont: .systemFont(ofSize: 21, weight: .semibold),
    ...
    static let iPod = PopoverTheme(
        ...
        font: NSFont(name: "Geneva", size: 22) ?? .monospacedSystemFont(ofSize: 22, weight: .regular),
        fontBold: NSFont(name: "Geneva", size: 22) ?? .monospacedSystemFont(ofSize: 22, weight: .bold),
        ...
        bubbleFont: NSFont(name: "Geneva", size: 19) ?? .monospacedSystemFont(ofSize: 21, weight: .medium),
    ...
    static var customFontSize: CGFloat = 22
